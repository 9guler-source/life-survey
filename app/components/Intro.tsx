...
export default function Intro({ lang, onStart }: IntroProps) {
  ...
  return (
    ...
    >
      ...
      <h1 className="font-serif text-4xl font-bold mb-4 leading-tight" style={{ color: "#e8c98a" }}>
        {lang === "ko" ? "나의 인생 나침반" :
         lang === "ja" ? "私の人生コンパス" :
         lang === "zh-hans" ? "我的人生罗盘" :
         lang === "zh-hant" ? "我的人生羅盤" :

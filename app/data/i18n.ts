...
export interface UIStrings {
  ...
  copyBtnLabel: string;
  copyBtnDone: string;
  copyInstructionTitle: string;
  copyInstructionList: string[];
  restartBtn: string;
  // 에러
  errorTitle: string;
  retryBtn: string;
...
export const UI: Record<LangCode, UIStrings> = {
  ko: {
    ...
    resultTitle: "SYS 인생 항해 점검표 — 나의 설문 응답 결과 확인서",
    resultSubtitle: "지금까지 살아온 길, 그리고 앞으로의 여정",
    resultThanks: "설문에 응답하시느라 수고 많으셨습니다.",
    resultExplain: "여러분의 인생을 돌아보고 정리하고, 또 앞으로 힘차게 나아갈 수 있는 힘을 얻는 계기가 되셨기를 기원합니다.\n\n그런데 죄송하게도 아직 기술의 미비와 역량의 부족으로 바로 이 자리에서 결과표를 보여드리지 못함을 양해해 주시고, 아래 '나의 설문 응답 결과 확인서 복사' 버튼을 누르시고 AI 앱(ChatGPT, Gemini, Claude, Grok, Perplexity 등)에 접속하여 대화창에 '붙여넣기'만 하시면 됩니다.\n\n아주 쉽고 간단하죠?",
    copyBtnLabel: "📋 나의 설문 응답 결과 확인서 복사",
    copyBtnDone: "✅ 복사 완료! AI 앱에 붙여넣어 보세요",
    copyInstructionTitle: "이렇게 사용하세요",
    copyInstructionList: [
      "위 버튼을 눌러 결과 확인서를 복사하세요",
      "ChatGPT, Gemini, Claude, Grok, Perplexity 등 좋아하는 AI 앱을 여세요",
      "대화창에 붙여넣기(Ctrl+V 또는 Cmd+V) 하세요",
      "AI가 당신만을 위한 인생 해설을 들려줄 거예요",
    ],
  ...
  en: {
    ...
    resultTitle: "SYS Life Voyage Checklist — My Survey Response Certificate",
    resultSubtitle: "The road you've walked, and the journey ahead",
    resultThanks: "Thank you for completing the survey.",
    resultExplain: "We hope this gave you a chance to look back on your life, reflect, and find renewed strength to move forward.\n\nUnfortunately, due to current technical limitations, we're not yet able to show your result directly here. Please press the 'Copy My Result Certificate' button below, open any AI app (ChatGPT, Gemini, Claude, Grok, Perplexity, etc.), and simply paste it into the chat.\n\nSimple, right?",
    copyBtnLabel: "📋 Copy My Survey Response Certificate",
    copyBtnDone: "✅ Copied! Now paste it into your AI app",
    copyInstructionTitle: "How to use it",
    copyInstructionList: [
      "Press the button above to copy your result certificate",
      "Open your favorite AI app — ChatGPT, Gemini, Claude, Grok, Perplexity, etc.",
      "Paste it into the chat (Ctrl+V or Cmd+V)",
      "The AI will share a personalized reading of your life journey",
    ],
  ...
  ja: {
    ...
    resultTitle: "SYS人生航海チェックリスト — 私の設問回答結果確認書",
    resultSubtitle: "歩んできた道、そしてこれからの旅へ",
    resultThanks: "アンケートにご回答いただき、ありがとうございました。",
    resultExplain: "ご自身の人生を振り返り整理し、これからを力強く歩むきっかけになれば幸いです。\n\n申し訳ございませんが、現在の技術的な制約により、この場で直接結果をお見せすることができません。下の「設問回答結果確認書をコピー」ボタンを押して、お好きなAIアプリ（ChatGPT、Gemini、Claude、Grok、Perplexityなど）を開き、チャット欄に「貼り付け」するだけで結果をご覧いただけます。\n\nとても簡単ですね？",
    copyBtnLabel: "📋 設問回答結果確認書をコピー",
    copyBtnDone: "✅ コピー完了！AIアプリに貼り付けてください",
    copyInstructionTitle: "使い方",
    copyInstructionList: [
      "上のボタンを押して結果確認書をコピーします",
      "ChatGPT、Gemini、Claude、Grok、Perplexityなどお好きなAIアプリを開きます",
      "チャット欄に貼り付け（Ctrl+V または Cmd+V）します",
      "AIがあなただけの人生の解説を伝えてくれます",
    ],
    restartBtn: "🔄 最初からやり直す",
  ...
  "zh-hans": {
    ...
    resultTitle: "SYS人生航海检查表 — 我的问卷回答结果确认书",
    resultSubtitle: "走过的路，以及前方的旅程",
    resultThanks: "感谢您完成本次问卷。",
    resultExplain: "希望这次问卷能成为您回顾、整理人生，并获得继续前行力量的契机。\n\n但很遗憾，由于目前技术上的限制，我们暂时无法在此直接为您展示结果。请点击下方「复制我的问卷回答结果确认书」按钮，打开任意AI应用（ChatGPT、Gemini、Claude、Grok、Perplexity等），在对话框中「粘贴」即可。\n\n是不是很简单？",
    copyBtnLabel: "📋 复制我的问卷回答结果确认书",
    copyBtnDone: "✅ 复制完成！请粘贴到AI应用中",
    copyInstructionTitle: "使用方法",
    copyInstructionList: [
      "点击上方按钮复制结果确认书",
      "打开您喜欢的AI应用——ChatGPT、Gemini、Claude、Grok、Perplexity等",
      "粘贴到对话框中（Ctrl+V 或 Cmd+V）",
      "AI将为您解读专属的人生故事",
    ],
    restartBtn: "🔄 重新开始",
    errorTitle: "出现了问题",
  ...
  "zh-hant": {
    ...
    resultTitle: "SYS人生航海檢查表 — 我的問卷回答結果確認書",
    resultSubtitle: "走過的路，以及前方的旅程",
    resultThanks: "感謝您完成本次問卷。",
    resultExplain: "希望這次問卷能成為您回顧、整理人生，並獲得繼續前行力量的契機。\n\n但很遺憾，由於目前技術上的限制，我們暫時無法在此直接為您展示結果。請點擊下方「複製我的問卷回答結果確認書」按鈕，打開任意AI應用（ChatGPT、Gemini、Claude、Grok、Perplexity等），在對話框中「貼上」即可。\n\n是不是很簡單？",
    copyBtnLabel: "📋 複製我的問卷回答結果確認書",
    copyBtnDone: "✅ 複製完成！請貼上到AI應用中",
    copyInstructionTitle: "使用方法",
    copyInstructionList: [
      "點擊上方按鈕複製結果確認書",
      "打開您喜歡的AI應用——ChatGPT、Gemini、Claude、Grok、Perplexity等",
      "貼上到對話框中（Ctrl+V 或 Cmd+V）",
      "AI將為您解讀專屬的人生故事",
    ],
    restartBtn: "🔄 重新開始",
    errorTitle: "出現了問題",
  ...
  es: {
    ...
    resultTitle: "Lista de Verificación del Viaje de Vida SYS — Mi Certificado de Resultados",
    resultSubtitle: "El camino recorrido y el viaje por delante",
    resultThanks: "Gracias por completar la encuesta.",
    resultExplain: "Esperamos que esto te haya dado la oportunidad de mirar atrás en tu vida, reflexionar, y encontrar fuerzas renovadas para seguir adelante.\n\nLamentablemente, debido a limitaciones técnicas actuales, todavía no podemos mostrarte el resultado directamente aquí. Por favor, presiona el botón 'Copiar mi Certificado de Resultados' a continuación, abre cualquier aplicación de IA (ChatGPT, Gemini, Claude, Grok, Perplexity, etc.) y simplemente pégalo en el chat.\n\nSencillo, ¿verdad?",
    copyBtnLabel: "📋 Copiar mi Certificado de Resultados de la Encuesta",
    copyBtnDone: "✅ ¡Copiado! Ahora pégalo en tu aplicación de IA",
    copyInstructionTitle: "Cómo usarlo",
    copyInstructionList: [
      "Presiona el botón de arriba para copiar tu certificado de resultados",
      "Abre tu aplicación de IA favorita: ChatGPT, Gemini, Claude, Grok, Perplexity, etc.",
      "Pégalo en el chat (Ctrl+V o Cmd+V)",
      "La IA compartirá una lectura personalizada de tu camino de vida",
    ],
  ...
  fr: {
    ...
    resultTitle: "Liste de Vérification du Voyage de Vie SYS — Mon Certificat de Résultats",
    resultSubtitle: "Le chemin parcouru et le voyage à venir",
    resultThanks: "Merci d'avoir complété le questionnaire.",
    resultExplain: "Nous espérons que cela vous a donné l'occasion de revenir sur votre vie, de réfléchir, et de retrouver des forces pour avancer.\n\nMalheureusement, en raison de limitations techniques actuelles, nous ne pouvons pas encore vous montrer le résultat directement ici. Veuillez appuyer sur le bouton 'Copier mon Certificat de Résultats' ci-dessous, ouvrir n'importe quelle application d'IA (ChatGPT, Gemini, Claude, Grok, Perplexity, etc.) et simplement le coller dans le chat.\n\nSimple, n'est-ce pas ?",
    copyBtnLabel: "📋 Copier mon Certificat de Résultats du Questionnaire",
    copyBtnDone: "✅ Copié ! Collez-le maintenant dans votre application d'IA",
    copyInstructionTitle: "Comment l'utiliser",
    copyInstructionList: [
      "Appuyez sur le bouton ci-dessus pour copier votre certificat de résultats",
      "Ouvrez votre application d'IA préférée : ChatGPT, Gemini, Claude, Grok, Perplexity, etc.",
      "Collez-le dans le chat (Ctrl+V ou Cmd+V)",
      "L'IA partagera une lecture personnalisée de votre parcours de vie",
    ],
  ...
  de: {
    ...
    resultTitle: "SYS Lebensreise-Checkliste — Mein Umfrage-Ergebniszertifikat",
    resultSubtitle: "Der Weg, den du gegangen bist, und die Reise, die vor dir liegt",
    resultThanks: "Danke, dass du die Umfrage abgeschlossen hast.",
    resultExplain: "Wir hoffen, dass dir das die Gelegenheit gegeben hat, auf dein Leben zurückzublicken, nachzudenken und neue Kraft zu finden, um weiterzugehen.\n\nLeider können wir dir das Ergebnis aufgrund aktueller technischer Einschränkungen noch nicht direkt hier zeigen. Bitte drücke den Button 'Mein Ergebniszertifikat kopieren' unten, öffne eine beliebige KI-App (ChatGPT, Gemini, Claude, Grok, Perplexity usw.) und füge es einfach in den Chat ein.\n\nEinfach, oder?",
    copyBtnLabel: "📋 Mein Umfrage-Ergebniszertifikat kopieren",
    copyBtnDone: "✅ Kopiert! Füge es jetzt in deine KI-App ein",
    copyInstructionTitle: "So funktioniert's",
    copyInstructionList: [
      "Drücke den Button oben, um dein Ergebniszertifikat zu kopieren",
      "Öffne deine bevorzugte KI-App — ChatGPT, Gemini, Claude, Grok, Perplexity usw.",
      "Füge es in den Chat ein (Strg+V oder Cmd+V)",
      "Die KI teilt dir eine persönliche Interpretation deines Lebensweges mit",
    ],
  ...
  ar: {
    ...
    resultTitle: "قائمة فحص رحلة الحياة SYS — شهادة نتيجة استبياني",
    resultSubtitle: "الطريق الذي سلكته والرحلة التي تنتظرك",
    resultThanks: "شكراً لإكمالك الاستبيان.",
    resultExplain: "نأمل أن تكون هذه فرصة للنظر إلى حياتك، والتأمل، وإيجاد قوة متجددة للمضي قدماً.\n\nللأسف، وبسبب قيود تقنية حالية، لا يمكننا حتى الآن عرض النتيجة مباشرة هنا. يُرجى الضغط على زر 'نسخ شهادة نتيجتي' أدناه، وفتح أي تطبيق ذكاء اصطناعي (ChatGPT أو Gemini أو Claude أو Grok أو Perplexity وغيرها)، ولصقها ببساطة في المحادثة.\n\nبسيط، أليس كذلك؟",
    copyBtnLabel: "📋 نسخ شهادة نتيجة استبياني",
    copyBtnDone: "✅ تم النسخ! الآن الصقها في تطبيق الذكاء الاصطناعي",
    copyInstructionTitle: "كيفية الاستخدام",
    copyInstructionList: [
      "اضغط على الزر أعلاه لنسخ شهادة نتيجتك",
      "افتح تطبيق الذكاء الاصطناعي المفضل لديك — ChatGPT أو Gemini أو Claude أو Grok أو Perplexity وغيرها",
      "الصقها في المحادثة (Ctrl+V أو Cmd+V)",
      "سيشاركك الذكاء الاصطناعي قراءة شخصية لمسار حياتك",
    ],

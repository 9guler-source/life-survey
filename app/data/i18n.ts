...
export const UI: Record<LangCode, UIStrings> = {
  ...
  en: {
    ...
    resultTitle: "My Survey Response Certificate",
  ...
  es: {
    ...
    resultTitle: "Mi Certificado de Resultados de la Encuesta",
  ...
  fr: {
    ...
    resultTitle: "Mon Certificat de Résultats du Questionnaire",
  ...
  de: {
    ...
    resultTitle: "Mein Umfrage-Ergebniszertifikat",
  ...
  ar: {
    ...
    resultTitle: "شهادة نتيجة استبياني",
